...
## Overview
 ...
 - Escaping the facility AI of first-person players introduced with action graph set up to reach such goal on top on general action graph (opening doors, picking up items etc.)
